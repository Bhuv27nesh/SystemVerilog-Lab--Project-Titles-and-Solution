...
class alignas(VL_CACHE_LINE_BYTES) Vtb___024root final : public VerilatedModule {
  public:
    ...
    Vtb_tb_pkg__03a__03areference_model__Vclpkg* tb_pkg__03a__03areference_model__Vclpkg;
    Vtb_tb_pkg__03a__03ascoreboard__Vclpkg* tb_pkg__03a__03ascoreboard__Vclpkg;

    // DESIGN SPECIFIC STATE
    CData/*3:0*/ tb__DOT____Vcellout__dut__q;
    CData/*3:0*/ tb__DOT__actual;
    CData/*3:0*/ tb__DOT__expected;

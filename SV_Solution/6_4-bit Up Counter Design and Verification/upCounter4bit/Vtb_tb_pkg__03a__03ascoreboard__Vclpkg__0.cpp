...
void Vtb_tb_pkg__03a__03ascoreboard::__VnoInFunc_check(Vtb__Syms* __restrict vlSymsp, CData/*3:0*/ actual, CData/*3:0*/ expected, IData/*31:0*/ cycle, CData/*0:0*/ clk, CData/*0:0*/ reset) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vtb_tb_pkg__03a__03ascoreboard::__VnoInFunc_check\n"); );
    // Body
    if (((IData)(actual) == (IData)(expected))) {
        VL_WRITEF_NX("%3d   | %0#   | %0#   | %01x      | %01x       | PASS\n",0,
                     32,cycle,1,(IData)(clk),1,reset,
                     4,(IData)(actual),4,expected);
    } else {
        VL_WRITEF_NX("%3d   | %0#   | %0#   | %01x      | %01x       | FAIL\n",0,
                     32,cycle,1,(IData)(clk),1,reset,
                     4,(IData)(actual),4,expected);
    }
}

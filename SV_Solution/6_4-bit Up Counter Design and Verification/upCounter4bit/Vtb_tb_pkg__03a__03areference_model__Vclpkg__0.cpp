...
void Vtb_tb_pkg__03a__03areference_model::__VnoInFunc_get_expected(Vtb__Syms* __restrict vlSymsp, CData/*0:0*/ reset, CData/*3:0*/ &get_expected__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vtb_tb_pkg__03a__03areference_model::__VnoInFunc_get_expected\n"); );
    // Body
    this->__PVT__ref_val = ((IData)(reset) ? 0U : (0x0000000fU 
                                                   & ((IData)(1U) 

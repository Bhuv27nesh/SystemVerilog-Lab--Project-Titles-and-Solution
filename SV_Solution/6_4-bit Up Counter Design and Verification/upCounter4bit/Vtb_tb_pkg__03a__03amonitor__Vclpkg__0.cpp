...
void Vtb_tb_pkg__03a__03amonitor::__VnoInFunc_sample(Vtb__Syms* __restrict vlSymsp, CData/*3:0*/ &sample__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vtb_tb_pkg__03a__03amonitor::__VnoInFunc_sample\n"); );
    // Body
    sample__Vfuncrtn = VL_NULL_CHECK(this->__PVT__vif, "tb_pkg.sv", 49)
        ->q;
}

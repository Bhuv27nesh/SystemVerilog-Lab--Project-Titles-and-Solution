...
VlCoroutine Vtb___024root___eval_initial__TOP__Vtiming__1(Vtb___024root* vlSelf) {
    ...
    VlClassRef<Vtb_tb_pkg__03a__03atransaction> __Vtask_gen_tr__4__Vfuncout;
    CData/*7:0*/ __Vtask_sample__6__Vfuncout;
    __Vtask_sample__6__Vfuncout = 0;
    // Body
    ...
    while (VL_GTS_III(32, 0x00000100U, tb__DOT__unnamedblk1__DOT__i)) {
        VL_NULL_CHECK(tb__DOT__gen, "tb.sv", 60)->__VnoInFunc_gen_tr(vlSymsp, tb__DOT__unnamedblk1__DOT__i, __Vtask_gen_tr__4__Vfuncout);
        vlSelfRef.tb__DOT__unnamedblk1__DOT__unnamedblk2__DOT__tr 
            = __Vtask_gen_tr__4__Vfuncout;
        co_await VL_NULL_CHECK(tb__DOT__drv, "tb.sv", 62)->__VnoInFunc_drive(vlSymsp, vlSelfRef.tb__DOT__unnamedblk1__DOT__unnamedblk2__DOT__tr);
        co_await vlSelfRef.__VdlySched.delay(0x00000000000003e8ULL, 
                                             nullptr, 
                                             "tb.sv", 
                                             64);
        VL_NULL_CHECK(tb__DOT__mon, "tb.sv", 66)->__VnoInFunc_sample(vlSymsp, __Vtask_sample__6__Vfuncout);
        vlSelfRef.tb__DOT__actual = __Vtask_sample__6__Vfuncout;
        if (((IData)(vlSelfRef.tb__DOT__actual) == VL_NULL_CHECK(vlSelfRef.tb__DOT__unnamedblk1__DOT__unnamedblk2__DOT__tr, "tb.sv", 69)
             ->__PVT__expected)) {
            VL_WRITEF_NX("%3d   |  %0#  |  %0#  |   %02x    |   %02x    | PASS\n",0,
                         32,tb__DOT__unnamedblk1__DOT__i,
                         1,(IData)(vlSymsp->TOP__tb__DOT__vif.clk),
                         1,vlSymsp->TOP__tb__DOT__vif.reset,
                         8,(IData)(vlSelfRef.tb__DOT__actual),
                         8,VL_NULL_CHECK(vlSelfRef.tb__DOT__unnamedblk1__DOT__unnamedblk2__DOT__tr, "tb.sv", 71)
                         ->__PVT__expected);
        } else {
            VL_WRITEF_NX("%3d   |  %0#  |  %0#  |   %02x    |   %02x    | FAIL\n",0,
                         ...
                         1,vlSymsp->TOP__tb__DOT__vif.reset,
                         8,(IData)(vlSelfRef.tb__DOT__actual),
                         8,VL_NULL_CHECK(vlSelfRef.tb__DOT__unnamedblk1__DOT__unnamedblk2__DOT__tr, "tb.sv", 75)
                         ->__PVT__expected);
        }
    ...
    vlSelfRef.__VactTriggered[0U] = VL_EXTEND_QI(64,4, 
                                                 (((vlSelfRef.__VdynSched.evaluate() 
                                                   ...
                                                   | (vlSelfRef.__VdlySched.awaitingCurrentTime() 
                                                      << 2U)) 
                                                  | ((((IData)(vlSymsp->TOP__tb__DOT__vif.reset) 
                                                       & (~ (IData)(vlSelfRef.__Vtrigprevexpr___TOP__tb__DOT__vif__reset__0))) 
                                                      << 1U) 

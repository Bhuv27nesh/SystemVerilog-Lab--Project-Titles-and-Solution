...
VlCoroutine Vtb___024root___eval_initial__TOP__Vtiming__1(Vtb___024root* vlSelf) {
    ...
    while (VL_GTS_III(32, 0x00000100U, tb__DOT__unnamedblk1__DOT__i)) {
        VL_NULL_CHECK(tb__DOT__gen, "tb.sv", 62)->__VnoInFunc_gen_tr(vlSymsp, tb__DOT__unnamedblk1__DOT__i, __Vtask_gen_tr__5__Vfuncout);
        vlSelfRef.tb__DOT__unnamedblk1__DOT__unnamedblk2__DOT__tr 
            = __Vtask_gen_tr__5__Vfuncout;
        co_await VL_NULL_CHECK(tb__DOT__drv, "tb.sv", 64)->__VnoInFunc_drive(vlSymsp, vlSelfRef.tb__DOT__unnamedblk1__DOT__unnamedblk2__DOT__tr);
        co_await vlSelfRef.__VdlySched.delay(0x00000000000003e8ULL, 
                                             nullptr, 
                                             "tb.sv", 
                                             66);
        VL_NULL_CHECK(tb__DOT__mon, "tb.sv", 68)->__VnoInFunc_sample(vlSymsp, __Vtask_sample__7__Vfuncout);
        vlSelfRef.tb__DOT__actual = __Vtask_sample__7__Vfuncout;
        VL_NULL_CHECK(tb__DOT__ref_model, "tb.sv", 69)->__VnoInFunc_get_expected(vlSymsp, VL_NULL_CHECK(vlSelfRef.tb__DOT__unnamedblk1__DOT__unnamedblk2__DOT__tr, "tb.sv", 69)
                                                                                ->__PVT__reset, __Vtask_get_expected__8__Vfuncout);
        vlSelfRef.tb__DOT__expected = __Vtask_get_expected__8__Vfuncout;
        VL_NULL_CHECK(tb__DOT__scb, "tb.sv", 71)->__VnoInFunc_check(vlSymsp, vlSelfRef.tb__DOT__actual, (IData)(vlSelfRef.tb__DOT__expected), tb__DOT__unnamedblk1__DOT__i, (IData)(vlSymsp->TOP__tb__DOT__vif.clk), vlSymsp->TOP__tb__DOT__vif.reset);
        tb__DOT__unnamedblk1__DOT__i = ((IData)(1U) 
                                        + tb__DOT__unnamedblk1__DOT__i);
    }
    VL_WRITEF_NX("-------------------------------------------------------------\nTEST COMPLETED\n-------------------------------------------------------------\n",0);
    VL_FINISH_MT("tb.sv", 78, "");
}

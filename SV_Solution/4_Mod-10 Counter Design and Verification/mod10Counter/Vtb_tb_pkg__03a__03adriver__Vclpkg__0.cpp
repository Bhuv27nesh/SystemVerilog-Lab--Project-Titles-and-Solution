...
VlCoroutine Vtb_tb_pkg__03a__03adriver::__VnoInFunc_drive(Vtb__Syms* __restrict vlSymsp, VlClassRef<Vtb_tb_pkg__03a__03atransaction> tr) {
    ...
    // Body
    VL_KEEP_THIS;
    VL_NULL_CHECK(this->__PVT__vif, "tb_pkg.sv", 34)->reset 
        = VL_NULL_CHECK(tr, "tb_pkg.sv", 34)->__PVT__reset;
    ...
    __Vtrigprevexpr_h362c623c__0 = VL_NULL_CHECK(this->__PVT__vif, "tb_pkg.sv", 35)
        ->clk;
    while ((1U & (~ (IData)(__VdynTrigger_h5052f4b9__0)))) {
        co_await vlSymsp->TOP.__VdynSched.evaluation(
                                                     ...
                                                     "tb_pkg.sv", 
                                                     35);
        __VdynTrigger_h5052f4b9__0 = (VL_NULL_CHECK(this->__PVT__vif, "tb_pkg.sv", 35)

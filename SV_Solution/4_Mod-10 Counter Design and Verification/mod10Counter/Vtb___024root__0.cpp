...
VlCoroutine Vtb___024root___eval_initial__TOP__Vtiming__1(Vtb___024root* vlSelf) {
    ...
    while (VL_GTS_III(32, 0x00000014U, tb__DOT__unnamedblk1__DOT__i)) {
        VL_NULL_CHECK(tb__DOT__gen, "tb.sv", 57)->__VnoInFunc_gen_tr(vlSymsp, tb__DOT__unnamedblk1__DOT__i, __Vtask_gen_tr__5__Vfuncout);
        vlSelfRef.tb__DOT__unnamedblk1__DOT__unnamedblk2__DOT__tr 
            = __Vtask_gen_tr__5__Vfuncout;
        co_await VL_NULL_CHECK(tb__DOT__drv, "tb.sv", 58)->__VnoInFunc_drive(vlSymsp, vlSelfRef.tb__DOT__unnamedblk1__DOT__unnamedblk2__DOT__tr);
        co_await vlSelfRef.__VdlySched.delay(0x00000000000003e8ULL, 
                                             nullptr, 
                                             "tb.sv", 
                                             60);
        VL_NULL_CHECK(tb__DOT__mon, "tb.sv", 62)->__VnoInFunc_sample(vlSymsp, __Vtask_sample__7__Vfuncout);
        vlSelfRef.tb__DOT__actual = __Vtask_sample__7__Vfuncout;
        VL_NULL_CHECK(tb__DOT__ref_model, "tb.sv", 63)->__VnoInFunc_get_expected(vlSymsp, VL_NULL_CHECK(vlSelfRef.tb__DOT__unnamedblk1__DOT__unnamedblk2__DOT__tr, "tb.sv", 63)
                                                                                ->__PVT__reset, __Vtask_get_expected__8__Vfuncout);
        vlSelfRef.tb__DOT__expected = __Vtask_get_expected__8__Vfuncout;
        VL_NULL_CHECK(tb__DOT__scb, "tb.sv", 65)->__VnoInFunc_check(vlSymsp, vlSelfRef.tb__DOT__actual, (IData)(vlSelfRef.tb__DOT__expected), tb__DOT__unnamedblk1__DOT__i, (IData)(vlSymsp->TOP__tb__DOT__vif.clk), vlSymsp->TOP__tb__DOT__vif.reset);
        tb__DOT__unnamedblk1__DOT__i = ((IData)(1U) 
                                        + tb__DOT__unnamedblk1__DOT__i);
    }
    VL_WRITEF_NX("-------------------------------------------------------------\n",0);
    VL_FINISH_MT("tb.sv", 69, "");
}
...
void Vtb___024root___nba_sequent__TOP__0(Vtb___024root* vlSelf) {
    ...
    vlSelfRef.tb__DOT__dut__DOT____Vcellout__dff_array__BRA__0__KET____DOT__dff_inst__q 
        = (1U & ((~ (IData)(vlSymsp->TOP__tb__DOT__vif.reset)) 
                 & vlSelfRef.tb__DOT__dut__DOT____VdfgRegularize_hde9c8ce8_0_0));
    ...
    vlSelfRef.tb__DOT__dut__DOT____Vcellout__dff_array__BRA__7__KET____DOT__dff_inst__q 
        = (1U & ((~ (IData)(vlSymsp->TOP__tb__DOT__vif.reset)) 
                 & (vlSelfRef.tb__DOT__dut__DOT____VdfgRegularize_hde9c8ce8_0_0 
                    >> 7U)));
    tb__DOT____Vcellout__dut__q = ((((((IData)(vlSelfRef.tb__DOT__dut__DOT____Vcellout__dff_array__BRA__7__KET____DOT__dff_inst__q) 
                                       << 3U) | ((IData)(vlSelfRef.tb__DOT__dut__DOT____Vcellout__dff_array__BRA__6__KET____DOT__dff_inst__q) 
                                                 << 2U)) 
                                     | (((IData)(vlSelfRef.tb__DOT__dut__DOT____Vcellout__dff_array__BRA__5__KET____DOT__dff_inst__q) 
                                         << 1U) | (IData)(vlSelfRef.tb__DOT__dut__DOT____Vcellout__dff_array__BRA__4__KET____DOT__dff_inst__q))) 
                                    << 4U) | ((((IData)(vlSelfRef.tb__DOT__dut__DOT____Vcellout__dff_array__BRA__3__KET____DOT__dff_inst__q) 
                                                << 3U) 
    ...
    vlSelfRef.tb__DOT__dut__DOT____VdfgRegularize_hde9c8ce8_0_0 
        = ((9U == (IData)(tb__DOT____Vcellout__dut__q))
            ? 0U : ((IData)(1U) + (IData)(tb__DOT____Vcellout__dut__q)));
    vlSymsp->TOP__tb__DOT__vif.q = tb__DOT____Vcellout__dut__q;
